...
import createSEGToolGroupAndAddTools from '/home/adrian/Escritorio/TFG/repositorio/Viewers/extensions/cornerstone-dicom-seg/src/utils/initSEGToolGroup';
import promptHydrateSEG from '/home/adrian/Escritorio/TFG/repositorio/Viewers/extensions/cornerstone-dicom-seg/src/utils/promptHydrateSEG';
...
function OHIFCornerstoneMetricsViewport(props: withAppTypes) {
  const {
    children,
    displaySets,
    viewportOptions,
...
OHIFCornerstoneMetricsViewport.propTypes = {
...
export default OHIFCornerstoneMetricsViewport;
