...
function IoUcalc(): number {

  //array of imageIDs
  //var images = csUtils.getViewportImageIds(Types.IViewport);


  //var debug = Types.PixelDataTypedArray;
  // var debug = utilities.getViewportImageIds(viewport);
